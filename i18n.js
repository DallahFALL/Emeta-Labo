/* * PROJET : e-META LABS
 * FICHIER : i18n.js (Traduction Intégrale + Pages Légales + Mémoire)
 */
...
const translations = {
    fr: {
        ...
        // --- ETAPE 3 ---
        step3_title: "03. Matrice Analyse", lbl_context: "Contexte Opérationnel", ph_context: "Décrivez votre situation actuelle, vos objectifs à 1-3 ans et vos défis majeurs...",
        lbl_file_upload: "📄 Joindre un Document (Optionnel)", btn_browse: "Parcourir...", lbl_no_file: "Aucun fichier",
        lbl_file_desc: "Propriété Intellectuelle garantie : Votre fichier sera scellé (Woleet).", legal_consent: "J'accepte la", link_privacy: "Politique de Confidentialité",
        lbl_wa_optin: "J'accepte de recevoir mon analyse par WhatsApp.", btn_submit: "Lancer l'Analyse IA", footer_rights: "Tous droits réservés.",
        modal_res_title: "Diagnostic Stratégique", btn_new_analysis: "Nouvelle Analyse", msg_reset_confirm: "Voulez-vous vraiment recommencer ?",
