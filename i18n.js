...
const translations = {
    fr: {
        ...
        exp_web3: "Web3 & Blockchain (Bitcoin OTS)",
        ...
        agnostic_desc: "De l'ingénierie d'affaires aux litiges internationaux les plus complexes, notre moteur polymorphe s'adapte à votre industrie. Cochez l'<strong>Auto-Détection IA</strong> si votre enjeu dépasse les cadres traditionnels.",
    ...
    ar: {
        ...
        priv_c4: "لضمان الحماية المطلقة لأفكارك ومفاهيمك، يتم تشفير أي مستند يتم تحميله على منصتنا فورًا (بخوارزمية SHA-256). يتم تثبيت هذه البصمة الرقمية الفريدة على تقنية البلوكشين العامة عبر بروتوكول OpenTimestamps. يمنحك هذا دليلاً رقميًا قاطعًا على إثبات الوجود بقيمة قانونية دولية...",
