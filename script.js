...
// ==========================================
// DICTIONNAIRE MULTILINGUE INTÉGRAL (Sans Woleet)
// ==========================================
const uiDict = {
    fr: {
        ...
        privContent: `
            ...
            <p style="margin-bottom:20px;">Chaque audit généré par e-META LABS fait l'objet d'un marquage temporel.<br><strong>Propriété :</strong> Le client est l'unique propriétaire du rapport final et des conclusions stratégiques.<br><strong>Certification :</strong> Pour garantir l'intégrité et l'antériorité de l'analyse, les métadonnées du rapport sont scellées par ancrage Blockchain Open-Source (OTS), rendant le document infalsifiable.<br><strong>Purge :</strong> Les fichiers sources sont automatiquement purgés de nos serveurs 24 heures après la livraison de l'audit.</p>
    ...
    en: {
        ...
        privContent: `
            ...
            <p style="margin-bottom:20px;">Each audit generated by e-META LABS is timestamped.<br><strong>Ownership:</strong> The client is the sole owner of the final report.<br><strong>Certification:</strong> The report metadata is sealed by Open-Source Blockchain anchoring.</p>
    ...
    es: {
        ...
        privContent: `
            ...
            <p style="margin-bottom:20px;">Cada auditoría generada por e-META LABS tiene una marca de tiempo mediante anclaje Blockchain Open-Source.</p>
    ...
    ar: {
        ...
        privContent: `
            ...
            <p style="margin-bottom:20px;">يمكن ختم البيانات الوصفية للتقرير عبر ربط البلوكشين مفتوح المصدر.</p>
